...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Scaffold(
          backgroundColor:
              stickerMode ? const Color(0xAA0F1117) : const Color(0xFF0F1117),
      ...
      child: Material(
        ...
        child: InkWell(
            ...
            child: const SizedBox(
                ...
                height: 30,
                child:
                    Icon(Icons.push_pin, size: 17, color: Color(0xFFCBD5E0)))),
      ),
    );
  }
        ...
        for (final value in kTextColorOptions)
          PopupMenuItem<int>(
            ...
            child: Row(children: [
              ...
              const Spacer(),
              if (textColorValue == value)
                const Icon(Icons.check, size: 18, color: Color(0xFF38A169)),
            ]),
          ),
      ],
      child: SizedBox(
  ...
  Widget _actionChip(
    ...
    return ActionChip(
      avatar: Icon(icon,
          size: 18, color: selected ? Colors.white : const Color(0xFFCBD5E0)),
      label: Text(label),
      onPressed: onTap,
      backgroundColor:
          selected ? const Color(0xFF4F6AF0) : const Color(0xFF1A202C),
      labelStyle: TextStyle(
          color: textColor, fontSize: fs(13), fontWeight: FontWeight.w700),
...
class _DesktopSidebar extends StatelessWidget {
  ...
  const _DesktopSidebar(
      {required this.activeTopicId, required this.onSelect, required this.fs});
        ...
        Padding(
            ...
            child:
              ...
              Text('Senior interview map',
                  style: TextStyle(
                      fontSize: fs(12.5), color: const Color(0xFFA0AEC0))),
            ])),
        Expanded(
            child: ListView.separated(
